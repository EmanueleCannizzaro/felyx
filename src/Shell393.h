...
namespace fe_base{		// Put classes into namespace fe_base
  ...
  //! Shell393 	==> 8-Node-Structural-Shell
  ...
  class Shell393:public SingleLayerShell{
    
  public:
    // Constructors
    // ------------
    //! Standard constructor for Shell393 element
    Shell393()             :SingleLayerShell(NodeCount){}
    //! Standard destructor for Shell393 element
    virtual ~Shell393()	{}
    //! Virtual clone function, needed in PtrVector
    virtual Shell393* Clone() const { return new Shell393(*this); } 
    ...
    //    virtual Material* GetLayerMaterialPtr(unsigned = 0); 
