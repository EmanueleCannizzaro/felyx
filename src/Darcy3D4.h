...
//! Darcy3D4 	==> 10-Node-3D-Structural-Tetraeder
  class Darcy3D4:public LcmElement{
    
  public:
    // Constructors
    // ------------
    //! Standard constructor for Darcy3D4 element
    Darcy3D4()		: LcmElement(NodeCount) { }
    //! Standard destructor for Darcy3D4 element
    virtual ~Darcy3D4()	{}
    //! Virtual clone function, needed in PtrVector
    virtual Darcy3D4* Clone() const { return new Darcy3D4(*this); }
    ...
    */
    ...
    void EvalDerivedShapeFunc(Dense_Matrix);
    ...
    void Flux(unsigned, unsigned, Dense_Vector, Dense_Vector , Dense_Vector);
