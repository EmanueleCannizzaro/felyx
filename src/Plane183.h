...
namespace fe_base{		// Put classes into namespace fe_base
  ...
  //! Plane183 	==> 8-Node-2D-Structural-Plane
  class Plane183:public BaseSolid{
    
  public:
    // Constructors
    // ------------
    //! Standard constructor for Plane183 element
    Plane183()		: BaseSolid(NodeCount) {}
    //! Standard destructor for Plane183 element
    virtual ~Plane183()	{}
    //! Virtual clone function, needed in PtrVector
    virtual Plane183* Clone() const { return new Plane183(*this); }
