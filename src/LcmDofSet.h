...
#ifndef LcmDofSet_h
#define LcmDofSet_h LcmDofSet_h
...
namespace fe_base{		// Put classes into namespace fe_base
  ...
  //! Class LcmDofSet is derived from bitset<6> to handle all dof stuff
  //! in nodes and elements
  class LcmDofSet : public bitset<6>{
    
  public:

    // Constructors
    // ------------
    LcmDofSet() : bitset<6>() {}			 // Empty constructor
    LcmDofSet(const string str) : bitset<6>(str,0,6) {} // "string" constructor
  ...
  // ---------------------------------------------
  LcmDofSet operator& (const LcmDofSet&, const LcmDofSet&);
