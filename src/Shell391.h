...
namespace fe_base{		// Put classes into namespace fe_base
  ...
  //! Shell391 	==> 8-Node-Structural-Shell
  ...
  class Shell391:public LayeredShell{
    
  public:
    // Constructors
    // ------------
    //! Standard constructor for Shell391 element
    Shell391()             :LayeredShell(NodeCount){}
    //! Standard destructor for Shell391 element
    virtual ~Shell391()	{}
    //! Virtual clone function, needed in PtrVector
    virtual Shell391* Clone() const { return new Shell391(*this); } 
    ...
    */
    ...
    /*! EvalDerivedDeformations is a Matrix of the values of the derived deformations with respect to 
      ...
      IP determines the specific point, means row of Evalpoints.
    */
   virtual void EvalDerivedDeformations( Dense_Matrix, const Dense_Matrix ,
					 const  Dense_Matrix, const Dense_Matrix, 
					 unsigned );
